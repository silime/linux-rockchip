...
extern int bcmsdh_oob_tsf_intr_register(bcmsdh_info_t *bcmsdh, bcmsdh_cb_fn_t oob_irq_handler,
	void* oob_irq_handler_context);
extern void bcmsdh_oob_tsf_intr_unregister(bcmsdh_info_t *sdh);

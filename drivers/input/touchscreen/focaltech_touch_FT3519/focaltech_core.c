...
#define FTS_DRM_PANEL_NOTIFIER_EN           0
...
#if IS_ENABLED(CONFIG_DRM) && IS_ENABLED(CONFIG_DRM_PANEL) && FTS_DRM_PANEL_NOTIFIER_EN
...
#else
    FTS_INFO("drm_panel notifier is not supported on this kernel");
#endif
#else
    ts_data->fb_notif.notifier_call = fb_notifier_callback;
